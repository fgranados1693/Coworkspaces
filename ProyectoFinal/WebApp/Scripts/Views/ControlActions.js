...
function ControlActions() {
	...
	this.URL_API = "https://localhost:44302/api/";
	this.URL_VIEWS = "https://localhost:44302/Home/";

	this.GetUrlApiService = function (service) {
		return this.URL_API + service;
	}
	this.GetUrlViewService = function (service) {
		return this.URL_VIEWS + service;
	}
	...
	this.FillTableMod = function (service, tableId, refresh) {
	...
	this.ShowMessageDivPersonalizado = function (type, message) {
		if (type == 'E') {
			$("#alert_personalizada").removeClass("alert alert-success alert-dismissable")
			$("#alert_personalizada").addClass("alert alert-danger alert-dismissable");
			$("#alert_message_personalizada").text(message);
		} else if (type == 'I') {
			$("#alert_personalizada").removeClass("alert alert-danger alert-dismissable")
			$("#alert_personalizada").addClass("alert alert-success alert-dismissable");
			$("#alert_message_personalizada").text(message);
		}
		$('.alert-personalizada').show();
	};
	...
	this.GetToApiFuncional = function (service) {
		var result = null;
		$.ajax({
			url: this.GetUrlApiService(service),
			type: 'get',

...
namespace WebApp.Helpers
{
    public static class ControlExtensions
    {
        ...
        public static HtmlString CtrlChartPie(this HtmlHelper html, string viewName, string id, string title,
            string labels, string chartType, string onLoadFunction)
        {
            var ctrl = new CtrlChartPieModel
            {
                ViewName = viewName,
                Id = id,
                Title = title,
        ...
        public static HtmlString CtrlInput(this HtmlHelper html, string id, string type, string label, string placeHolder = "", string columnDataName = "", string idLabel = "")
        {
        ...
        public static HtmlString CtrlDropDown(this HtmlHelper html, string id, string label, string listId, string placeHolder = "", string columnDataName = "")
        {
